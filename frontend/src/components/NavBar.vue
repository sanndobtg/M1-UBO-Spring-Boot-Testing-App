  ...
  <nav class="navbar" :class="{ scrolled: isScrolled }">
    <div class="navbar-inner">
      ...
      <RouterLink to="/" class="logo">
        ...
        <span class="logo-text glitch-text">VOD<span class="logo-accent">_SYS</span></span>
        <span class="logo-bracket">]</span>
      ...
      <div class="nav-auth">
        ...
        <template v-else>
          ...
          <RouterLink to="/register" class="btn-cyber btn-cyber-pink">
